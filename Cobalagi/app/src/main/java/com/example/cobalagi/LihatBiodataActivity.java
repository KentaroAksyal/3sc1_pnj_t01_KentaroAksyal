...
public class LihatBiodataActivity extends AppCompatActivity {
    ...
    TextView txtNomor, txtNama, txtUsername, txtPassword, txtAlamat, txtJeniskelamin, txtTglLahir, txtVaksin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtVaksin = findViewById(R.id.textValueVaksin);
        SQLiteDatabase db = dataHelper.getReadableDatabase();
        cursor = db.rawQuery("SELECT no, username, password, nama, tgl, jk, alamat,vaksinisasi FROM biodata WHERE nama = '" +
        ...
        if (cursor.getCount() > 0) {
            ...
            txtVaksin.setText(cursor.getString(7));
        }
    }
